                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $total_data = "SELECT COUNT(*) AS jumData FROM `tbl_kota` ORDER BY `Kd_Kota`";
                      ...
                      <tr>
                        ...
                        <td><div align="center"><?php echo $data['Kota'] ?></div></td>
                        <td align="center">
                        <a href="edit_kota.php? id=<?php echo $data['id_kota'] ?>">
                          <img src="assets/img/edit.png" width="20" alt="">
                        </a>&nbsp;
                        <a href="javascript:delete_data(<?php echo $data['id_kota'] ?>)">
