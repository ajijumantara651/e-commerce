                  ...
                  <table class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th width="274">
                          <div align="center">Nama Supplier</div>
                        </th>
                        <th width="178">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $total_data = "SELECT COUNT(*) AS jumData FROM `tbl_supplier` ORDER BY `Kd_Supplier`";
                      ...
                      <tr>
                        ...
                        <td><div align="center"><?php echo $data['Telp'] ?></div></td>
                        <td><div align="center"><?php echo $data['Alamat'] ?></div></td>
                        <td align="center">
                        <a href="edit_supplier.php? id=<?php echo $data['id_supplier'] ?>">
                          <img src="assets/img/edit.png" width="20" alt="">
                        </a>&nbsp;
                        <a href="javascript:delete_data(<?php echo $data['id_supplier'] ?>)">
                          <img src="assets/img/delete.png" width="20" alt="">
                        </a>
                        </td>
                      </tr>
