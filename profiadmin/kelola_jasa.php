            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                     <div class="panel-body">
                         <div class="table-responsive">                            
                             ...
                             <table class="table table-striped table-bordered table-hover" >
                                 <thead>
                                    <tr>
                                      <th width="61"><div align="center">No.</div></th>
                                      <th width="190"><div align="center">Nama Jasa Pengiriman</div></th>
                                      <th width="478"><div align="center">Durasi Pengiriman</div></th>
                                      <th width="142"><div align="center">Ongkos Kirim</div></th>
                  ...
                  <?php
									  ...
									  $total_data  = "SELECT COUNT(*) AS jumData FROM `tbl_jasakirim` ORDER BY `id_jasa`";
                    ...
                    <td><div align="center"><?php echo $No ?></div></td>
									  <td><div align="center"><?php echo $data['Nama_Jasa'] ?></div></td>
									  <td><div align="left"><?php echo $data['Durasi'] ?></div></td>
									  <td><div align="left"><?php echo $data['Ongkir'] ?></div></td>

                    <td align="center">
                      <a href="edit_jasa.php?id_jasa=<?php echo $data['id_jasa'] ?>"><img src="assets/img/edit.png"
                      width="20"></a>&nbsp;
                      <a href="javascript:delete_data(<?php echo $data['id_jasa'] ?>)">
