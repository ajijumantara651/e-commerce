                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $total_data = "SELECT COUNT(*) AS jumData FROM `tbl_produk` INNER JOIN `tbl_kategori` ON `tbl_produk`.`Kd_Kategori` = `tbl_kategori`.`Kd_Kategori` INNER JOIN `tbl_supplier` ON `tbl_produk`.`Kd_Supplier` = `tbl_supplier`.`Kd_Supplier` ORDER BY `id_barang`";

                        $query = "SELECT * FROM `tbl_produk` INNER JOIN `tbl_kategori` ON `tbl_produk`.`Kd_Kategori` = `tbl_kategori`.`Kd_Kategori` INNER JOIN `tbl_supplier` ON `tbl_produk`.`Kd_Supplier` = `tbl_supplier`.`Kd_Supplier` ORDER BY `id_barang` LIMIT $offset, $dataPerPage";
                      ...
                      <tr>
                        ...
                        <td><div align="center"><?php echo $data['Tanggal_Beli'] ?></div></td>
                        <td><div align="center"><?php echo $data['Stok'] ?></div></td>
                        <td><div align="center"><?php echo number_format($data['Harga_Beli'],0,',','.') ?></div></td>
                        <td><div align="center"><img src="produk/<?php echo $data['Foto'] ?>" width="100"></div></td>
                        <td align="center">
                        <?php
                          if($data['Stok'] <= 5){
                            echo"Perlu Penambahan Stock";
                          }else{
                            echo"Cukup";
                          }
                        ?>
