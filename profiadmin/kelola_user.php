...
<script type="text/javascript">
    function delete_data(id)
     {
       if(confirm('Anda Yakin Menghapus Data User Dengan Kode : '+id+' ?'))
         {
                             ...
                             <table class="table table-striped table-bordered table-hover" >
                                 <thead>
                                    <tr>
                                      ...
                                      <th width="274"><div align="center">Username</div></th>
                                      <th width="178"><div align="center">Password</div></th>
                                      <th width="178"><div align="center">Nama</div></th>
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      $total_data  = "SELECT COUNT(*) AS jumData FROM `tbl_user` ORDER BY `username`";
                                                        $query = "SELECT * FROM `tbl_user` ORDER BY `password` LIMIT $offset, $dataPerPage";
                                      ...
                                      <td align="center">
                                        <a href="edit_user.php?id=<?php echo $data['id'] ?>"><img src="assets/img/edit.png"
                                        width="20"></a>&nbsp;
