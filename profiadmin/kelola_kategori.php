                  ...
                  <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $total_data = "SELECT COUNT(*) AS jumData FROM `tbl_kategori` ORDER BY `Kategori`";
                        ...
                        <tr>
                          ...
                          <td><div align="center"><?php echo $data['Kategori'] ?></div></td>                          <td align="center">
                          <a href="edit_kategori.php? id=<?php echo $data['id_kategori'] ?>">
                            <img src="assets/img/edit.png" width="20" alt="">
                          </a>&nbsp;
                          <a href="javascript:delete_data(<?php echo $data['id_kategori'] ?>)">
